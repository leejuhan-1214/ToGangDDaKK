...
export function createHistoryView({dialog,regions,onOpen,onClose}){
 ...
 const markup=`<header class="history-head"><div><span class="eyebrow">OBSERVED EARTH</span><h2>시간을 겹쳐 보다<span>실제 자료</span></h2></div><button id="history-close" class="close-btn" aria-label="연도 비교 닫기">×</button></header>
